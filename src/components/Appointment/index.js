...
export default function Appointment(props) {
  ...
  return (
    ...
    interviewers={props.interviewers} interviewer={props.interview.interviewer.id} 
    bookInterview={props.bookInterview}
    onCancel={onCancel} onSave={save}/>}
    {mode === CONFIRMING && <Confirm message = "Are you sure you would like to delete?" onCancel={onCancel} onConfirm={onConfirm}/>}
